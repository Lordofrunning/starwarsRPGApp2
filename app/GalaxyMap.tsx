...
const planetData = [
  ...
  { name: 'Glee Anselm', x: 972, y: 742, info: "Glee Anselm was an ocean planet located in the Jalor system of the galaxy's Mid Rim that was the homeworld of the Anselmi and Nautolan species. known for its beautiful oceans and beaches, a popular tourist planet", imperialPrecence: 5, rim: 'Mid Rim', extra: '', underWorld: 1,},
  { name: 'Kril Dor', x: 911, y: 728, info: "Kril'Dor was a planet located in the galaxy's Mid Rim that was a source of tibanna gas. Located close to the Uba system, Kril'Dor was positioned at the coordinates I-7 on the Standard Galactic Grid.", imperialPrecence: 5, rim: 'Mid Rim', extra: '', underWorld: 6,},
  { name: 'Ansion', x: 942, y: 674, info: "Ansion was a planet located in the Mid Rim. A border dispute occurred on Ansion during the Separatist Crisis, which, along with turmoil on the planet Ando, was enough to stagger the galaxy.", imperialPrecence: 5, rim: 'Mid Rim', extra: '', underWorld: 3,},
