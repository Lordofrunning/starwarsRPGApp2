...
const planetData = [
  ...
  { name: 'Castell', x: 1323, y: 912, info: "Castell was a planet in the Castell system. It was part of the Confederacy of Independent Systems during the Clone Wars. After the Clone Wars ended, Castell was captured by Republic forces. Until the Galactic Civil War, when it switched hands to the Galactic Empire.", imperialPrecence: 6, rim: 'Colonies', extra: ''},
  { name: 'Carida', x: 1339, y: 941, info: "Carida was a mountainous planet in the Colonies region. During the Clone Wars, the Valor space station orbited it, while the Imperial Era saw it home to an Imperial academy and Imperial Navy Deepdock Facility Two.", imperialPrecence: 9, rim: 'Colonies', extra: ''},
  ...
  { name: 'Duro', x: 1344, y: 1212, info: "Duro was a temperate Core Worlds planet home to the Duros species.", imperialPrecence: 4, rim: 'Core', extra: ''},
  { name: 'Rendili', x: 1351, y: 1159, info: "Rendili was an ancient, conservative planet in the Core Worlds. Its system of shipyards across the Mid Rim Territories and Outer Rim Territories gave it a temporary ascendancy. In the Imperial Era, it supported the Galactic Emperor Sheev Palpatine.", imperialPrecence: 7, rim: 'Core', extra: ''},
  { name: 'Kuat', x: 1379, y: 1065, info: "Kurt was a vital shipbuilding and industrial planet in the Core Worlds home to the Kuati people. Kuat Drive Yards' legendary Kuat shipyards was a single, large man-made ring circling its equator. It made warships for both the Galactic Republic and Galactic Empire.", imperialPrecence: 8, rim: 'Core', extra: ''},
  { name: 'Cato Neimoidia', x: 1407, y: 1152, info: "Cato Neimoidia was a planet in the Quellor sector of the Colonies region that was a Purse World of the Neimoidians and the base of operations of the Trade Federation. Much of it was covered in a persistent fog and it had bridge cities above its acidic oceans.", imperialPrecence: 4, rim: 'Core', extra: ''},
  { name: 'Name', x: 1428, y: 1230, info: "Quellor was a planet in the Colonies region of the galaxy. By 4 ABY, Quellor had become an Imperial fortress world. It was still under Imperial control in 7 ABY", imperialPrecence: 10, rim: 'Colonies', extra: ''},
